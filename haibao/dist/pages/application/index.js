  ...
  return _c(
    ...
    [
        ...
        [
          _c(
            ...
            [
              _c(
                "view",
                { staticClass: "item", class: { active: _vm.tabIndex == 0 } },
                [
                  _vm.tabIndex == 0
                    ? _c("image", {
                        attrs: {
                    ...
                    : _c("image", {
                        attrs: {
                          src:
                            "https://campaign5.method-ad.cn/hypertherm/img/show/icon_application2.png"
                        }
                      }),
                  _vm._v(" "),
                  _c("text", [_vm._v("应用")])
          ...
          _c(
            ...
            [
              _c(
                "view",
                { staticClass: "item", class: { active: _vm.tabIndex == 1 } },
                [
                  _vm.tabIndex == 1
                    ? _c("image", {
                        attrs: {
                          src:
                            "https://campaign5.method-ad.cn/hypertherm/img/show/icon_pro2.png"
                        }
                      })
                    : _c("image", {
                        attrs: {
      ...
      _c("view", { staticClass: "list-box" }, [
        ...
        _c(
          "view",
          { staticClass: "list", class: { "list-all": !_vm.viewAll1 } },
          _vm._l(_vm.list1, function(item, index) {
            return _c(
              "navigator",
              {
                staticClass: "item",
                attrs: { url: "/pages/application/list?app_id=" + item.app_id }
              },
              [
                ...
                _vm._v(" "),
                _c("view", { staticClass: "txt" }, [_vm._v(_vm._s(item.title))])
              ]
            )
          }),
          1
      ...
      _c("view", { staticClass: "list-box" }, [
        ...
        _c(
          "view",
          { staticClass: "list", class: { "list-all": !_vm.viewAll2 } },
          _vm._l(_vm.list2, function(item, index) {
            return _c(
              "navigator",
              {
                staticClass: "item",
                attrs: {
                  url: "/pages/application/list?product_id=" + item.product_id
                }
              },
              [
                _c("view", { staticClass: "img-box" }, [
